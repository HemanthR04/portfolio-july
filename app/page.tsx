...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-start h-screen mx-4">
      ...
      <div>
          <p className=" my-4 py-4 font-bold tracking-normal leading-5"><span className="text-xs tracking-tighter">[ A SHORT INTRO ]</span> <br></br> I&apos;M A CREATIVE WEB DEVELOPER WHO LOVES BUILDING WEBSITES<Image className="rounded-full w-[48px] inline-block mx-2   " src={'/assets/introLaptop.jpg'} alt="Intro" width={100} height={100}></Image> AND COOL DIGITAL EXPERIENCES. FROM DESIGNING SMOOTH, USER-FRIENDLY INTERFACES TO CRAFTING ENGAGING ONLINE JOURNEYS, I MIX CREATIVITY AND TECH SKILLS IN EVERY PROJECT.</p>
      </div>
